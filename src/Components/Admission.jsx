    ...
    return(
        ...
        <section className="bg-indigo-400">
            ...
            <div className="flex flex-col md:flex-row md:justify-center p-20">
                <div className="flex flex-col space-y-4 w-1/3 bg-orange-200 p-12">
                ...
                <div className="flex flex-col space-y-4 w-1/3 bg-orange-300 p-10">
                ...
                <div className="flex flex-col space-y-4 w-1/3 bg-amber-500 p-12">
