...
const Admission=()=>{
    return(
        ...
        <section className="bg-indigo-400 py-10">
            ...
            <div className="flex flex-col md:flex-row md:justify-center md:p-20 p-0 ">
                <div className="flex flex-col space-y-4 md:w-1/3 w-full bg-orange-200 p-12">
                ...
                <div className="flex flex-col space-y-4 md:w-1/3 w-full bg-orange-300 p-10">
                ...
                <div className="flex flex-col space-y-4 md:w-1/3 w-full bg-amber-500 p-12">
