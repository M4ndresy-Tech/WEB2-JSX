...
const Pedagogique= ()=> {
    return(
        <>
        <section className="flex md:flex-row flex-col justify-center gap-8 p-35">
         ...
         <div className="flex flex-col gap-12 md:text-left sm:text-center">
            ...
            <div className="text-blue-950 text-lg"><p>Suivant le système LMD, jusqu’au Master, 
                notre formation repose sur un programme pédagogique conçu en adéquation avec les attentes du marché.
                 ...
                 <div className="">  
                    <button className="text-2xl text-blue-950 font-bold m-auto border-2 border-b-blue-950 hover:bg-blue-950
                     hover:text-white p-2 rounded whitespace-nowrap">Notre programme</button></div>
         </div>
        </section>

    
           
      <section className="flex flex-col gap-10 md:pb-30 sm:px-35">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          <div className="bg-amber-100 pt-8 pb-15 px-7 rounded-3xl text-left">
            ...
            <p className="text-blue-950 text-2xl font-bold pt-5">Apprentissage théoriques en présentiel</p>
          </div>
          <div className="bg-amber-100 pt-8 pb-15 px-7 rounded-3xl text-left">
            <h2 className="text-amber-400  text-5xl font-bold">25%</h2>
            <p className="text-blue-950 text-2xl font-bold pt-5">Apprentissage sur supports numériques</p>
          </div>
          <div className="bg-amber-100 pt-8 pb-15 px-7 rounded-3xl text-left">
            <h2 className="text-amber-400  text-5xl font-bold">25%</h2>
            <p className="text-blue-950 text-2xl font-bold pt-5">Travaux individuels de l’étudiant</p>
          </div>
          <div className="bg-amber-100 pt-8 pb-15 px-7 rounded-3xl text-left">
            <h2 className="text-amber-400  text-5xl font-bold">25%</h2>
            <p className="text-blue-950 text-2xl font-bold pt-5">Apprentissage en entreprise</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <img src={img3} alt="prestation" className="rounded w-full" />
        </div>
      </section>
     </>
